...
void RtOptimizer::AddResidualItem(const Eigen::Vector2d &uv, const Eigen::Vector3d &xyz,const Eigen::Matrix3d &K){
  ceres::CostFunction *cost_function = PnPCeres::Create(uv, xyz, K);
